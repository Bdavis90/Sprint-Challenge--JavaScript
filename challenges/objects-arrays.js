...
let schools = graduates.filter(school => school.university.includes('Uni'))
colleges.push(schools)
...
const lowerCase = [];
let lowerName = zooAnimals.map(function(lower){
...
let lowPop = zooAnimals.filter(function(pop){
  if(pop.population < 5){
